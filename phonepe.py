...
if select == "Home":
    ...
    with col2:
        st.video("D:\GUVI\Projects\Phonepe\Phonepe Add1.mp4")

    col3,col4= st.columns(2)
    
    with col3:
        st.video("D:\GUVI\Projects\Phonepe\Phonepe Add2.mp4")
    ...
    with col6:
        st.video("D:\GUVI\Projects\Phonepe\Phonepe Add3.mp4")
